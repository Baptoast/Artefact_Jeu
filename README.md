...
Chaque tour ce déroule en plusieurs phase, la phase **actions** et la phase **délibération**.
...
Une fois deux actions parmis celle-ci dessus choisies (peut être deux fois les mêmes), et que tout les autres joueurs ont choisis également leurs actions, la phase de délibération commence.

2) La phase **délibération**
...
Une fois la phase de délibération finie, la phase du choix des actions recommence et ainsi de suite.
